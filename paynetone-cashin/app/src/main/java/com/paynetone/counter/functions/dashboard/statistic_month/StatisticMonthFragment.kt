package com.paynetone.counter.functions.dashboard.statistic_month
...
import com.paynetone.counter.databinding.StatisticMonthFragmentBinding
...
class StatisticMonthFragment :  Fragment() {
    ...
    private var binding: StatisticMonthFragmentBinding by autoCleared()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        binding = StatisticMonthFragmentBinding.inflate(inflater,container,false)
        initView()
        return binding.root
    }
...
//            valueFormatter = MyXAxisFormatter()
    ...
    companion object{
        const val maxSumAmount = 9000f
        const val minSumAmount = 0f

        const val maxQuantity = 1800f
